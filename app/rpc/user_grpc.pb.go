// Code generated by protoc-gen-go-rpcserver. DO NOT EDIT.
// versions:
// - protoc-gen-go-rpcserver v1.2.0
// - protoc             v3.15.8
...
func (c *userServiceClient) SetUserRating(ctx context.Context, in *SetUserRatingRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	out := new(EmptyResponse)
	err := c.cc.Invoke(ctx, "/proto.UserService/SetUserRating", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) SetUserRating(context.Context, *SetUserRatingRequest) (*EmptyResponse, error) {
...
func _UserService_SetUserRating_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetUserRatingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).SetUserRating(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.UserService/SetUserRating",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SetUserRating(ctx, req.(*SetUserRatingRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// UserService_ServiceDesc is the rpcserver.ServiceDesc for UserService service.
// It's only intended for direct use with rpcserver.RegisterService,
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _UserService_SetUserRating_Handler,
		},
	},
...
// OrderService_ServiceDesc is the rpcserver.ServiceDesc for OrderService service.
// It's only intended for direct use with rpcserver.RegisterService,
// and not to be introspected or modified (even as a copy)
